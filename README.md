...
Run the install command again to update. Review [SKILL.md](skills/redacted-crypto-resources/SKILL.md) before installing, or use the [direct ZIP download](https://askredacted.xyz/downloads/redacted-crypto-resources.zip). The ZIP also works with `npx skills add` using its full URL.
